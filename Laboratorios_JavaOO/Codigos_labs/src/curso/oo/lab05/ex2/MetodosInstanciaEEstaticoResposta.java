...
public class MetodosInstanciaEEstaticoResposta {
	...
	public static void main(String[] args) {
		...
		String strInst1 = new String("Sou uma instÃ¢ncia de objeto da classe String");
		String strInst2 = "Viva com paixÃ£o!";
		...
		String strInst3 = b ? "Sim" : "NÃ£o";

		System.out.println("As variÃ¡veis strInst1 " + " e strInst2 tem o mesmo" + " conjunto de caracteres? " + strInst3);
		...
		// VocÃª já usou o método estático parseInt() da classe
		...
		// método endsWith()
		String str = "Hello";
		// todo 2 - Analise o que é chamada por método de instância ou estático
